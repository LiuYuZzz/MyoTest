...
public:
	...
	void recData() {
		...
		//cout << "predict gesture" << endl;
		if (GetAsyncKeyState(VK_SPACE)) {
			UINT predictClassLabel = svm.getPredictedClassLabel();
...
int main(int argc, char** argv) {
	try {
		...
		GestureListener collector("C:\\Users\\LiuYu\\Desktop\\Data\\ClassLabelFile.txt",
			"C:\\Users\\LiuYu\\Desktop\\Data\\Model\\SVMModel.txt");
